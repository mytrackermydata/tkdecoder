defmodule TkDecoder do
  ...
  ### Examples
      ...
      {:ok, "[SG*0123456*0002*LK]", %{acc: nil, altitude: nil, battery: "80", content: ["0", "80"], content_type: "LK", device: "012", device_id: "0123456", device_timestamp: nil, direction: nil, firm: "SG", gsm_signal: nil, latitude: nil, latitude_mark: nil, lbs_stations: nil, lenght: "0009", located: nil, longitude: nil, longitude_mark: nil, roll: nil, satellites: nil, speed: nil, status: nil, steps: "0"}}

      iex> TkDecoder.parse("[SG*0123456*0009*LK,0,80,1]")
      {:ok, "[SG*0123456*0002*LK]", %{acc: "1", altitude: nil, battery: "80", content: ["0", "80", "1"], content_type: "LK", device: "012", device_id: "0123456", device_timestamp: nil, direction: nil, firm: "SG", gsm_signal: nil, latitude: nil, latitude_mark: nil, lbs_stations: nil, lenght: "0009", located: nil, longitude: nil, longitude_mark: nil, roll: nil, satellites: nil, speed: nil, status: nil, steps: "0"}}
